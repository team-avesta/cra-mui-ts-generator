			...
			{(injectedProps: IInjectedProps) => (
				<>
					<Typography variant="subtitle2">
						One Time Password (OTP) has been sent to your registered mobile number, please enter the same
						here to verify it.
					</Typography>
					...
					<Typography variant="body1">
						If you didn&apos;t receive your OTP within 2 minutes, click the <strong>RESEND OTP</strong>{' '}
